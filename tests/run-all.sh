...
fail=0
for t in t1-counting t2-e2e t3-iplimit t4-api t6-d1-tunnel t7-traffic-api t8-health-diag t9-leak t10-tunnel-leak t11-ttl-evict t12-ui-security t13-disguise t14-v3-backend t15-exit-radar t16-v3-ui t17-v3-ui-stage4; do
  printf '\n════════ %s ════════\n' "$t"
